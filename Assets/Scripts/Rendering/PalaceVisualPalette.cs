...
/// <summary>
/// Shared Palace color language. Gameplay definitions may provide their own identity color, while
/// common interaction and threat feedback should come from this asset for visual consistency.
/// </summary>
[CreateAssetMenu(fileName = "PalaceVisualPalette", menuName = "Ink Shinobi/Rendering/Palace Visual Palette")]
public sealed class PalaceVisualPalette : ScriptableObject {
  ...
  [Header("Environment")]
  [Tooltip("Default Palace water accent; individual water materials may still vary around it.")]
